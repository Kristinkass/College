...
#Проверьте наличие на складе всех лекарств и их доступность.
# Для администратора будет сгенерирован запрос, позволяющий просмотреть все лекарства,
# срок их годности, информацию о производителях и всю другую информацию.
...
#Администратор сможет видеть всех пользователей, которые сделали заказ или приобрели что-либо оффлайн.
...
# Администратор сможет увидеть текущую очередь заказов и все относящиеся к ней детали.
